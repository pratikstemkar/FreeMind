...
public class PostDetailAdapter extends RecyclerView.Adapter<PostDetailAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.post_detail_item, viewGroup, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ImageView image_profile, hot, star, verified_img, more;
        public TextView username, likes, date, text_post, category;
